...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('frontend/admin/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css') }}">
    <!-- iCheck -->
    ...
    <!-- summernote -->
    <link rel="stylesheet" href="{{ asset('frontend/admin/plugins/summernote/summernote-bs4.min.css') }}">
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="{{ asset('frontend/admin/dist/img/AdminLTELogo.png') }}"
    ...
    <script src="{{ asset('frontend/admin/plugins/daterangepicker/daterangepicker.j') }}s"></script>
    <!-- Tempusdominus Bootstrap 4 -->
    <script src="{{ asset('frontend/admin/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js') }}">
    </script>
    <!-- Summernote -->
