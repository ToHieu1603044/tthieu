                ...
                <div class="row">
                   ...
                   <div class="col-md-3 col-sm-6">
                     <div class="products">
                        ...
                        <div class="thumbnail"><a href="{{ route('product.detail',$item->id) }}"><img width="200px" src="{{ \Storage::url($item['img']) }}" alt="{{ $item->name }}"></a></div>
                        <div class="productname"><a href="{{ route('product.detail',$item->id) }}">{{ $item['name'] }}</a></div>
                        <h4 class="price">{{ $item['price_sell'] }}</h4>
                        <div class="button_group"> <a href="{{ route('cart',$item) }}" class="button add-cart">Add to cart</a>
