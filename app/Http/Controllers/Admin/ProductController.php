...
class ProductController extends Controller
{
    ...
    public function store(StoreProductRequest $request)
    {
        try {
            ...
            return redirect()->route('products.index')->with('success', TextSystemConst::CREATE_SUCCESS);
        } catch (Exception $e) {
            Log::error($e);
            DB::rollBack();

            return redirect()->route('products.index')->with('errors', TextSystemConst::CREATE_FAILED);
        }
    }
